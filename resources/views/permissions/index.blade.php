...
@section('content-title')
    @include('layouts.content-title',['title' =>'Izinleri Listele','first' => '','second' => ''])
@endsection
                                            ...
                                            <td class="d-flex justify-content-sm-around align-items-center">
                                                ...
                                                @if($domain->is_active )
                                                    <a class="btn btn-danger btn-sm "
                                                       href="{{route('permissions.activate',['id' => $domain->id])}}">
